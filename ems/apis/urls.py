...
router.register('mode', ModeViewSet),
router.register('issueType', IssueTypeViewSet),
router.register('formType', FormTypeViewSet),
router.register('gstType', GstTypeViewSet),
router.register('gender', GenderViewSet),
router.register('maritalStatus', MaritalStatusViewSet),
...
router.register('AccountType', AccountTypeViewSet),
router.register('AccountPreference', AccountPreferenceViewSet),
...
router.register('courierFiles', CourierFileViewSet),
