...
class ArnEntryModel(models.Model):
    ...
    arnPincode = models.IntegerField(max_length=6, null=True, blank=True)
...
class AmcEntryModel(models.Model):
    ...
    amcPincode = models.IntegerField(max_length=6, null=True, blank=True)
...
class AumEntryModel(models.Model):
    id = models.AutoField(primary_key=True)
    arnNumber = models.ForeignKey(ArnEntryModel, on_delete=models.CASCADE, related_name="arnNumber", null=True, blank=True)
    amcAbbreviation = models.ForeignKey(AmcEntryModel, on_delete=models.CASCADE, related_name="amcAbbreviation", null=True, blank=True)
...
class GstEntryModel(models.Model):
    ...
    gstGgst = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    hideStatus = models.IntegerField(default=0)
    createdAt = models.DateTimeField(auto_now_add=True)
    updatedAt = models.DateTimeField(auto_now=True)
...
class StatementModel(models.Model):
    ...
    statementSipBankAccountLastFourDigit = models.IntegerField(max_length=4, null=True, blank=True)
    ...
    statementPrimaryBankAccountLastFourDigit = models.IntegerField(max_length=4, null=True, blank=True)
    hideStatus = models.IntegerField(default=0)
    createdAt = models.DateTimeField(auto_now_add=True)
    updatedAt = models.DateTimeField(auto_now=True)
...
class ClientModel(models.Model):
    ...
    clientPassportLicenseNo = models.CharField(max_length=500, null=True, blank=True, unique=True)
    ...
    clientResidencialStatus = models.CharField(max_length=500, null=True, blank=True)
...
class ClientPresentAddressModel(models.Model):
    ...
    clientPresentCountry = models.ForeignKey(CountryModel, on_delete=models.CASCADE, related_name="clientPresentCountry", null=True, blank=True)
...
class ClientPermanentAddressModel(models.Model):
    ...
    clientPermanentCountry = models.ForeignKey(CountryModel, on_delete=models.CASCADE, related_name="clientPermanentCountry", null=True, blank=True)
...
class ClientOfficeAddressModel(models.Model):
    ...
    clientOfficeDistrict = models.CharField(max_length=500, null=True, blank=True)
...
class ClientOverseasAddressModel(models.Model):
    ...
    clientOverseasDistrict = models.CharField(max_length=500, null=True, blank=True)
    ...
    clientOverseasCountry = models.ForeignKey(CountryModel, on_delete=models.CASCADE, related_name="clientOverseasCountry", null=True, blank=True)
    hideStatus = models.IntegerField(default=0)
    createdAt = models.DateTimeField(auto_now_add=True)
    updatedAt = models.DateTimeField(auto_now=True)
...
class ClientMedicalInsuranceModel(models.Model):
    ...
    clientMedicalInsurancePolicyMaturityAmount = models.CharField(max_length=500, null=True, blank=True)
...
class ClientTermInsuranceModel(models.Model):
    ...
    clientTermInsurancePolicyMaturityAmount = models.CharField(max_length=500, null=True, blank=True)
